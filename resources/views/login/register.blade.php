    ...
    <div class="col-md-4 p-5 shadow-sm border rounded-5 border-info">
        ...
        <form action="/login/create" method="post">
            ...
            <div class="mb-3">
                ...
                <input type="nik" name="nik" value="{{ Session::get('nik') }}"  class="form-control bg-info bg-opacity-10 border border-info">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="tlp" name="tlp" value="{{ Session::get('tlp') }}"  class="form-control bg-info bg-opacity-10 border border-info">
            </div>
            <div class="mb-3">
